...
import { Hash, Building2, User2, Package, Calendar } from 'lucide-react';
...
export default function PrintReleaseForm({ requisition, hospital_name }: Props) {
    ...
    return (
        <div className="min-h-screen bg-white p-12 text-black print:p-0">
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="border-b-2 border-black bg-gray-50">
                            ...
                            <th className="py-3 px-4 text-right text-[10px] font-black uppercase tracking-widest tracking-widest">Remarks</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            {/* Footer */}
            <div className="fixed bottom-12 left-12 right-12 text-center text-[8px] text-gray-400 font-mono uppercase tracking-[0.2em] print:absolute print:bottom-4">
