...
export default function EditUser({ user, userRoles, roles, departments }: Props) {
        ...
        <>
            ...
            <div className="mx-auto max-w-2xl space-y-5 p-5">
                <div className="flex items-center gap-4">
                    ...
                    <PageHeader
                        title="Edit User"
                        description={`Update ${user.name}'s account details.`}
                    />
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 rounded-lg border border-[#E1E3E5] bg-white p-6">
                    ...
                    <div>
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-1.5">
                                <Label htmlFor="password" className="text-xs font-medium text-[#202223]">New Password</Label>
                                <Input id="password" type="password" value={data.password} onChange={(e) => setData('password', e.target.value)} placeholder="Leave blank to keep current" className="border-[#babfc3] focus-visible:ring-[#008060]" />
                                {errors.password && <p className="text-xs text-[#D82C0D]">{errors.password}</p>}
                            </div>
                            <div className="space-y-1.5">
                                <Label htmlFor="password_confirmation" className="text-xs font-medium text-[#202223]">Confirm New Password</Label>
