...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('departments', function (Blueprint $table) {
            ...
            $table->foreignUlid('head_user_id')->nullable()->constrained('users')->nullOnDelete();
        ...
        Schema::create('units_of_measure', function (Blueprint $table) {
            ...
            $table->foreignUlid('base_unit_id')->nullable()->constrained('units_of_measure')->nullOnDelete();
        ...
        Schema::table('users', function (Blueprint $table) {
            $table->foreignUlid('department_id')->nullable()->after('password')->constrained()->nullOnDelete();
